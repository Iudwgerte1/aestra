...
inline std::map<std::string, SPSAParamVar> spsaParams = {{"lmrBias", SPSAParam<float>{0.75f, 0.0f, 1.0f, 2.25f, 0.002f}},
                                                         {"lmrDivisor", SPSAParam<float>{2.25f, 1.0f, 5.0f, 0.2f, 0.002f}},
                                                  ...
                                                  {"nmpDivisor", SPSAParam<int>{3, 0, 10, 1.0f, 0.002f}}};

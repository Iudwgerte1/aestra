...
#elif defined(__MINGW32__) || defined(__MINGW64__) || defined(__CYGWIN__) || defined(_WIN32)
/* MinGW, Cygwin and other Windows/COFF targets don't support this directive either */
...
/* Real MSVC cannot inline-assemble .incbin; clang can (its integrated assembler
 * supports it on COFF), so let clang use the assembly embedding below. */
